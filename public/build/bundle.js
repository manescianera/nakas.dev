...
var app = (function () {
    ...
    /* src/pages/Home.svelte generated by Svelte v3.46.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-10who6k");
    			add_location(a, file$1, 5, 0, 95);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ message, href });
    ...
    function create_default_slot(ctx) {
    	...
    	route = new Route({
    			props: { basepath: true, component: Home },
    			$$inline: true
    		});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Home, url });
